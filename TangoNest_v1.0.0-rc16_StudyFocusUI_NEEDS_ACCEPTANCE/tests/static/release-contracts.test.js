...
assert.match(serviceWorker,/tangonest-shell-v1\.0\.0-rc\.16/);
...
assert.ok(Buffer.byteLength(style)+Buffer.byteLength(focusStyle)<150000,"Combined CSS must stay within the rc16 cleanup ceiling");
...
assert.equal(version,"1.0.0-rc.16");
assert.match(html,/1\.0\.0-rc\.16-pdca6/,"The final asset build must bust stale rc16 caches");
for(const asset of ["style.css","ui/study-focus.css","app.js","learning-engine.js","tn-supabase-sync.js","tn-library-management.js","tn-learning-flow.js","ui/learning-presentation.js","ui/runtime.js"]){
