...
TangoNest is a vocabulary library for collecting, organizing, reviewing, quizzing, and listening to words. This repository is the `1.0.0-rc.12` authentication-stability candidate.
...
Run `SUPABASE_AUTH_FIX.sql` once in the Supabase SQL Editor before testing rc.12 authentication. It repairs table grants, RLS policies, and required columns without deleting existing vocabulary. `SUPABASE_SQL_RUN_ONCE.sql` remains the complete new-project schema.
