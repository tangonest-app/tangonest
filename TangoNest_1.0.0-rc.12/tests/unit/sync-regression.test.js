...
(async () => {
  ...
  assert.strictEqual(partialDataApp.window.db.lists.length,1,"playlist data still loads when words permission is broken");
  ...
  assert.strictEqual(loginApp.state.playlists.length,1,"login and SIGNED_IN listener do not create duplicate default playlists");
