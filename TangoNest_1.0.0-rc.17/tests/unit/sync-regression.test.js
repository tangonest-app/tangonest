...
function createContext({session, playlists = [], words = [], playlistStore = null, wordStore = null, failCloud = false, failTables = [], tableError = "", storage = {}, initialDb = null, signUpSession = undefined, signUpError = null, loginSession = undefined, loginError = null, sessionError = null, localQa = false, missingEnsureRpc = false}){
  ...
  const state = {session,signUpSession,signUpError,loginSession,loginError,sessionError,playlists:playlistStore||[...playlists],words:wordStore||[...words],failCloud,failTables:new Set(failTables),tableError,channels:[],warnings:[],errors:[],learningEvents:new Set(),missingEnsureRpc};
  const mockConsole = {
