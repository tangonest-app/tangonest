...
assert.match(sql,/lower\(btrim\(p\.name\)\) in \('my words','new playlist','starter','default'\)[\s\S]+updated_at-p\.created_at[\s\S]+not exists/i,"Legacy cleanup is limited to empty untouched generated candidates");
