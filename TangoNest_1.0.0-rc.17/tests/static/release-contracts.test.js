...
assert.match(serviceWorker,/tangonest-shell-v1\.0\.0-rc\.17-pdca3/);
...
assert.match(html,/1\.0\.0-rc\.17-pdca3/,"The final asset build must bust stale pre-rc17 caches");
