-- TangoNest v1.0.0-rc17 canonical production schema
-- Run in Supabase SQL Editor.
--
-- IMPORTANT:
-- The first authenticated launch after this release performs one intentional,
-- account-scoped clean start. It deletes that account's words/playlists and
-- recreates exactly one My Words playlist. A DB marker makes it run only once.
...
revoke all on public.tn_playlists, public.tn_words, public.tn_learning_events, public.tn_account_migrations from anon, authenticated;
