...
assert.match(serviceWorker,/tangonest-shell-v1\.0\.0-rc\.17-pdca6/);
assert.match(serviceWorker,/\.\/default-playlist\.js/);
...
assert.equal(version,"1.0.0-rc.17");
assert.match(html,/1\.0\.0-rc\.17-pdca6/,"The final asset build must bust stale pre-rc17 caches");
for(const asset of ["style.css","ui/study-focus.css","default-playlist.js","app.js","learning-engine.js","tn-supabase-sync.js","tn-library-management.js","tn-learning-flow.js","ui/learning-presentation.js","ui/runtime.js"]){
