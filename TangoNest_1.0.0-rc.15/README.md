...
TangoNest is a vocabulary library for collecting, organizing, reviewing, quizzing, and listening to words. This repository is the `1.0.0-rc.15` Study Focus UI/UX release candidate. It preserves the stabilized Auth, data, and sync architecture from rc.14.
...
Run the root-level `SUPABASE_SCHEMA_CURRENT.sql` once in the Supabase SQL Editor before deploying rc.15. It is the single canonical, idempotent-oriented schema and migration for existing and new projects. It preserves existing vocabulary while enabling unfiled words, current learning fields, RLS, Realtime, and required RPCs.
