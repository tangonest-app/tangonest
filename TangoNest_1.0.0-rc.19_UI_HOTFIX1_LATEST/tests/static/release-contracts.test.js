...
assert.match(serviceWorker,/tangonest-shell-v1\.0\.0-rc\.19-uihotfix1/);
...
assert.match(html,/1\.0\.0-rc\.19-uihotfix1/,"The final asset build must bust all pre-hotfix caches");
