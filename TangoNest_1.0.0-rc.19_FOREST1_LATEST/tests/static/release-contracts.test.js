...
assert.match(serviceWorker,/tangonest-shell-v1\.0\.0-rc\.19-forest1/);
assert.match(serviceWorker,/\.\/default-playlist-rc19-forest1\.js/);
...
assert.ok(Buffer.byteLength(style)+Buffer.byteLength(focusStyle)<150000,"Combined CSS must stay within the release cleanup ceiling");
assert.equal((style.match(/!important/g)||[]).length+(focusStyle.match(/!important/g)||[]).length,0,"Presentation CSS must not rely on !important overrides");
assert.doesNotMatch(focusStyle,/gradient\(/i,"The active Study Focus theme must not use gradients");
...
assert.match(html,/1\.0\.0-rc\.19-forest1/,"The forest redesign must bust all earlier asset caches");
for(const asset of ["style-rc19-forest1.css","ui/study-focus-rc19-forest1.css","default-playlist-rc19-forest1.js","app-rc19-forest1.js","learning-engine-rc19-forest1.js","tn-supabase-sync-rc19-forest1.js","tn-library-management-rc19-forest1.js","tn-learning-flow-rc19-forest1.js","ui/learning-presentation-rc19-forest1.js","ui/runtime-rc19-forest1.js"]){
  assert.match(html,new RegExp(`${asset.replace(/[.]/g,"\\.")}\\?v=${version.replace(/[.]/g,"\\.")}-forest1`),`Cache-safe deployed asset: ${asset}`);
}

const deployedCopies=new Map([
  ["style.css","style-rc19-forest1.css"],
  ["ui/study-focus.css","ui/study-focus-rc19-forest1.css"],
  ["config.js","config-rc19-forest1.js"],
  ["default-playlist.js","default-playlist-rc19-forest1.js"],
  ["learning-engine.js","learning-engine-rc19-forest1.js"],
  ["ui/learning-presentation.js","ui/learning-presentation-rc19-forest1.js"],
  ["app.js","app-rc19-forest1.js"],
  ["tn-supabase-sync.js","tn-supabase-sync-rc19-forest1.js"],
  ["tn-library-management.js","tn-library-management-rc19-forest1.js"],
  ["tn-learning-flow.js","tn-learning-flow-rc19-forest1.js"],
  ["ui/runtime.js","ui/runtime-rc19-forest1.js"],
  ["manifest.json","manifest-rc19-forest1.json"]
]);
